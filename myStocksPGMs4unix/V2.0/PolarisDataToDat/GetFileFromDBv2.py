...
#           外資庫存, 投信庫存, 自營商庫存, 法人庫存 // 20180526 新增庫存資料
select_sql = "SELECT DATE, START_PRICE, HIGH_PRICE, LOW_PRICE, END_PRICE, VOLUME, MARGIN_TRADING, SHORT_SELLING, foreign_stock, sit_and_cb_stock, self_employed_stock, legal_person_stock FROM TAIWAN_DATA_POLARIS_STOCKS WHERE STOCK_NO = %s ORDER BY DATE "
...
try:
	...
	if len(sys.argv) < 2 :
		...
		print("syntax : C:\python GetFileFromDBv2.py 2002")
		sys.exit()
